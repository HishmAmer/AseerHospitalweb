...
def load_env_file(path):
    """يقرأ ملف .env إن وُجد، دون أي اعتماد خارجي.

    متغيّرات البيئة الحقيقية لها الأولوية، فمنصّات مثل Render تظل تعمل
    كما هي، ويبقى الملف وسيلة مريحة للتركيب على خادم داخلي.
    """
    if not path.exists():
        return
