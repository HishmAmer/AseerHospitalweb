...
class Employee(models.Model): 
    ...
    ('صومالي', 'صومالي'), ('موريتاني', 'موريتاني'), ('جيبوتي', 'جيبوتي'), ('قمري', 'قمري'),
    
    # --- دول آسيا (العمالة الشائعة) ---
    ('هندي', 'هندي'), ('فلبيني', 'فلبيني'), ('باكستاني', 'باكستاني'), 
    ('بنغلاديشي', 'بنغلاديشي'), ('إندونيسي', 'إندونيسي'), ('سريلانكي', 'سريلانكي'), 
    ('نيبالي', 'نيبالي'), ('ماليزي', 'ماليزي'), ('أفغاني', 'أفغاني'), ('ميانماري', 'ميانماري'),
    
    # --- دول آسيا (أخرى) ---
    ('صيني', 'صيني'), ('ياباني', 'ياباني'), ('كوري', 'كوري'), 
    ('تايلاندي', 'تايلاندي'), ('فيتنامي', 'فيتنامي'), ('سنغافوري', 'سنغافوري'),
    ('تركي', 'تركي'), ('إيراني', 'إيراني'), ('أوزبكي', 'أوزبكي'), ('طاجيكي', 'طاجيكي'),
    
    # --- دول أفريقيا ---
    ('جنوب أفريقي', 'جنوب أفريقي'), ('نيجيري', 'نيجيري'), ('كينى', 'كينى'),
    ('إثيوبي', 'إثيوبي'), ('إريتري', 'إريتري'), ('تشادي', 'تشادي'),
    ('غاني', 'غاني'), ('أوغندي', 'أوغندي'), ('مالي', 'مالي'), ('سنغالي', 'سنغالي'),
    ('كوت ديفوار', 'كوت ديفوار'), ('كاميروني', 'كاميروني'), ('رواندي', 'رواندي'),
    ...
    # --- الأمريكتين وأوقيانوسيا ---
    ('أمريكي', 'أمريكي'), ('كندي', 'كندي'), ('أسترالي', 'أسترالي'),
    ('نيوزيلندي', 'نيوزيلندي'), ('برازيلي', 'برازيلي'), ('أرجنتيني', 'أرجنتيني'),
    ('فنزويلي', 'فنزويلي'), ('مكسيكي', 'مكسيكي'), ('كولومبي', 'كولومبي'), ('كوبي', 'كوبي'),
    
    # --- أخرى / حالات خاصة ---
    ('بدون جنسية', 'بدون جنسية'), # هامة جداً في أنظمة الـ HR لبعض الحالات
    ('أخرى', 'أخرى')
)
